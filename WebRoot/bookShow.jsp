...
<div id="sidebar">
                                       ...
                                       <ul class="navigation">
											...
											<li  class="active" ><a href="bookShow.jsp" style="left: 0px; width: 192px;">修改删除书籍</a></li>
											  ...
											  <li ><a href="orderSearch.action" style="left: 0px; width: 183px;">查看订单</a></li>
 ...
 <c:if test="${searchword!=null}" var="result" scope="session">									
								...
								<tr id="<s:property value="#status.isbn"/>"> 
    							     ...
    							     <td width="7%">${item.author }&nbsp;</td>  
    							     <td width="10%">${item.press }&nbsp;</td> 
    							     <td width="20%">${item.publicationDate }&nbsp;</td>  
    							     <td width="5%">${item.price }&nbsp;</td>
    							     <td width="35%">${item.discription }&nbsp;</td>
    							     
    							      <td width="10%"> <a href="bookDelete.action?book.isbn=${item.isbn}"><button>删除</button></a></td>
    							</tr>
    							</s:iterator>									
								</table>									
						        </div>
